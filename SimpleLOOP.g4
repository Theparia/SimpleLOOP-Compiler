...
methodCallStatement
    : expression {System.out.println("MethodCall");} LeftParenthesis methodArguments RightParenthesis
    ;

mergeStatement
    : expression Dot Merge {System.out.println("MERGE");} LeftParenthesis expression RightParenthesis
    ;
